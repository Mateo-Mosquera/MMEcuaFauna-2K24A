...
public class MMActionPanel extends MMPanel {
    ...
    public MMActionPanel(MMHormigueroPanel hormigueroPanel) {
        ...
        buttonAlimentarGA.setBackground(MMStyles.MMCOLOR_PURPLE1); //Color de Alimentar con Genoalimento
        buttonAlimentarIN.setBackground(MMStyles.MMCOLOR_PURPLE1); // Color de Alimentar con Ingesta Nativa
