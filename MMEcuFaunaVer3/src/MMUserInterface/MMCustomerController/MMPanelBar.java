...
public class MMPanelBar extends JPanel {
    ...
    public MMPanelBar(JFrame frame) {
        ...
        setBackground(MMStyles.MMCOLOR_BLUE1); // Fondo cuadro superior 
        ...
        // fuente y el texto
        MMButton closeButton = new MMButton("X", true, MMStyles.MMFONT_LANGOSTIONS_SMALL);
        MMButton minimizeButton = new MMButton("_", true, MMStyles.MMFONT_LANGOSTIONS_SMALL);
        MMButton maximizeButton = new MMButton("O", true, MMStyles.MMFONT_LANGOSTIONS_SMALL);
