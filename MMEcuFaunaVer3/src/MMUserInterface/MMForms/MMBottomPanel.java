...
public class MMBottomPanel extends MMPanel {
    ...
    public MMBottomPanel(MMHormigueroPanel hormigueroPanel) {
        ...
        buttonEliminar.setBackground(MMStyles.MMCOLOR_DANGER_RED);  // Color de Eliminar Boton
        buttonEliminar.setForeground(Color.BLACK);  // Color de Eliminar LEtra

        buttonGuardar.setBackground(MMStyles.MMCOLOR_GOLD);// Color de Guardar Boton
        buttonGuardar.setForeground(Color.BLACK);  // Color de Guardar LEtra
